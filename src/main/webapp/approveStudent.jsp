...
<body>
	...
	<div class="pt-8 px-16">
		<div class="px-4 sm:px-0">
			<h3 class="text-base font-semibold leading-7 text-gray-900">Profile
				Information</h3>
			<p class="mt-1 max-w-2xl text-sm leading-6 text-gray-500">Personal
				details.</p>
		</div>
		<div class="mt-2 border-t border-gray-100">
			<dl class="divide-y divide-gray-100">
				...
				<div class="px-4 py-2 grid grid-cols-5 gap-4 px-0">
					...
					<dd class="text-sm leading-6 text-gray-700 col-span-2 mt-0">Mufassir
						Ahmad Chowdhury</dd>
				</div>
				<div class="px-4 py-2 grid grid-cols-5 gap-4 px-0">
				...
				<div class="px-4 py-2 grid grid-cols-5 gap-4 px-0">
					<dt class="text-sm font-medium leading-6 text-gray-900">Current
						Semester</dt>
				...
				<div class="px-4 py-2 grid grid-cols-5 gap-4 px-0">
					<dt class="text-sm font-medium leading-6 text-gray-900">Phone
						Number</dt>
